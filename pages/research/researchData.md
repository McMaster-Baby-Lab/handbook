...
**Benefits of Backing Up Data in SharePoint:**
- Automatic backup of all research data
- Ability to restore any deleted data
- Permission control
- Saves local hard drive space (files will be downloaded on demand)
  - After uploading the files, if you want to free up hard drive space, you can right-click the files and click "Free Up Space."
  - You can always download the files whenever you need them.
