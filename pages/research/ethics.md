...
2. After you log in, Dr. Xiao will create an application form under our ethics protocol. You will receive an email from MREB informing you that you are a member of this research project.
3. Use the [templates](https://mcmasteru365.sharepoint.com/:f:/r/sites/labtest/Shared%20Documents/Research%20ethics%20documents/Templates?csf=1&web=1&e=xikbEd) and [examples](https://mcmasteru365.sharepoint.com/:f:/r/sites/labtest/Shared%20Documents/Research%20ethics%20documents/Examples?csf=1&web=1&e=sChwzM) in the Research Ethics Documents folder to prepare your application.
...
- **Section 1.6:** Students should select option 1 in Section 1.6 after they receive feedback about their MREB application submission. This way, they will be able to upload a summary of the changes they have made to their application before resubmitting for approval.
- **Section 2.8:** Add your name if you are in the original program of research ethics application. Otherwise, you can choose "Yes" in Section 2.9 and add your own information.
- **Section 3.1:** Please answer the following questions to complete this section. It is important to provide a detailed procedure in this part (e.g., trials, duration). You should change the parts that are unique to your own project. Leave the Recruitment Plan and Confidentiality/Data Storage/Consent in other sections.
  1. **Number and description of participants for this chapter project (e.g., children and parents)**

     Fill in based on study-specific information.

  2. **Specific recruitment plan (children and parents)**
  ...
  3. **Methodology**
     ...
     Describe how you are collecting data (e.g., questionnaire), where (e.g., Zoom, telephone), how long the interview/experiment will take, audio/video recordings, transcription (children and parents).

     Fill in based on study-specific information.

  4. **Confidentiality and Data Storage**

     Are you collecting identifying information? Where and how long will you keep identifiable data (contact info, recordings)? Where and how long will you keep the de-identified research data/transcripts?
  ...
  6. **Please make sure to go over the template and remove those parts which don't apply to your study.**
     ...
     For example, for an online study, you need to delete or revise references to signatures, sign-up sheets, or any other statements that do not apply to this individual study. (e.g., in the Confidentiality and Data Storage section, it is not necessary to include "Participants or their legal guardian's names, signatures, and email addresses will be collected for informed consent purposes" or "We will also collect participants' or their legal guardians' names and signatures on a signup sheet to indicate that they received the participation incentives (compensation)." )
...
## Ethics Revision
- Select *My revised program of research form* in response to ethics review comments from the MREB Chair (option 1) at 1.6, and upload your responses to the comments as a PDF file.
