...
# Typical Scenarios Related to Family and Child Information
{: .no_toc }
...
2. Select *Search*.
3. Type in full or partial information into any of the contact information fields.
...
We have a form on the lab website for families who are interested in participating to fill out. We use the information they provided to add new families to the DRDB system so that researchers know they are available to participate in studies. We may also receive emails from families who are interested in participating.
...
1. Navigate to the *Family Information* page.
2. Search for the desired family.
3. Select *Edit* under the child's name.
...
1. Navigate to the *Family Information* page.
2. Search for the desired family.
3. Use the *Notes* tab on the right-hand side to type any additional information (e.g., "Parent prefers email communication").
...
You can use this [spreadsheet](https://mcmasteru365-my.sharepoint.com/:x:/g/personal/xiaon8_mcmaster_ca/EeFyaQJH4H9Imh_JzXojHeIBMCzy0mAj9DaezEQK0Ri5iQ?e=8jJIrM) as a template to upload multiple participants' information at once.
- All information should be formatted as TEXT in the spreadsheet (including phone numbers, DoB, etc.).
